(function ($) {
    ...
    function bindData(template, data, settings) {
      ...
      processElements("data-content", template, data, settings, function (
        $elem,
        value
      ) {
      ...
      processElements("data-content-append", template, data, settings, function (
        $elem,
        value
      ) {
      ...
      processElements("data-content-prepend", template, data, settings, function (
        $elem,
        value
      ) {
      ...
      processElements("data-content-text", template, data, settings, function (
        $elem,
        value
      ) {
      ...
      processElements("data-innerHTML", template, data, settings, function (
        $elem,
        value
      ) {
        $elem.html(applyFormatters($elem, value, "content", settings));
      ...
      processElements("data-alt", template, data, settings, function (
        $elem,
        value
      ) {
      ...
      processElements("data-title", template, data, settings, function (
        $elem,
        value
      ) {
      ...
      processElements("data-id", template, data, settings, function (
        $elem,
        value
      ) {
      ...
      processElements("data-css", template, data, settings, function (
        $elem,
        value
      ) {
      ...
      processElements("data-class", template, data, settings, function (
        $elem,
        value
      ) {
      ...
      processElements("data-link", template, data, settings, function (
        $elem,
        value
      ) {
        var $linkElem = $("<a/>");
      ...
      processElements("data-link-wrap", template, data, settings, function (
        $elem,
        value
      ) {
        var $linkElem = $("<a/>");
      ...
      processElements("data-options", template, data, settings, function (
        $elem,
        value
      ) {
        $(value).each(function () {
      ...
      processElements("data-value", template, data, settings, function (
        $elem,
        value
      ) {
              ...
              case "options":
                ...
                $(value).each(function () {
                  ...
                  $option
                    ...
                    .attr(
                      "selected",
                      typeof this[optionsData.value.selected] == undefined
                        ? false
    ...
    addTemplateFormatter("nestedTemplateFormatter", function (
      value,
      options,
      internalSettings
    ) {
